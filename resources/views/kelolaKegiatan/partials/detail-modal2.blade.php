<!-- Modal -->
<div class="modal fade" id="detailModal{{ $kegiatan->kd_kegiatan2 }}" tabindex="-1" aria-labelledby="detailModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless">
                            <tr>
                                <td width="30%">Komunitas</td>
                                <td>: {{ $kegiatan->komunitas->nm_komunitas }}</td>
                            </tr>
                            <tr>
                                <td>Kategori</td>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" onclick="showAddPhotoModal2('{{ $kegiatan->kd_kegiatan2 }}')">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger"
                    onclick="confirmDeleteKegiatan('{{ $kegiatan->kd_kegiatan2 }}')">
