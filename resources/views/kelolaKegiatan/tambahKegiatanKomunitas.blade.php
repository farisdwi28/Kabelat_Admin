    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kelolaKegiatan2.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Nama Kegiatan -->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Program Komunitas *</label>
                                    <select class="form-select @error('kd_komunitas') is-invalid @enderror" name="kd_komunitas"
                                        required>
                                        <option value="">Pilih Komunitas</option>
                                        @foreach ($komunitas as $K)
                                            <option value="{{ $K->kd_komunitas }}"
                                                {{ old('kd_komunitas') == $K->kd_komunitas ? 'selected' : '' }}>
                                                {{ $K->nm_komunitas }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <a href="{{ route('kelolaKegiatan2.index') }}" class="btn btn-danger">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
