            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('informasiBerita.create') }}">
                ...
                <div class="card-body pt-0">
                    <div class="table-responsive">
                        <table class="table datatable" id="datatable_1">
                            ...
                            <tbody>
                                @foreach ($informasiBerita as $info)
                                    <tr>
                                        <td>{{ $info->judul_berita }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('informasiBerita.edit', ['kd_info' => $info->kd_info]) }}"
                ...
                link.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`/kelolaInformasi/kelolaInformasiBerita/${beritaId}/${newStatus}`, {
                                    method: 'POST',
                                    headers: {
            ...
            deleteLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`/kelolaInformasi/kelolaInformasiBerita/${beritaId}`, {
                                    method: 'DELETE',
                                    headers: {
                                        'X-CSRF-TOKEN': document.querySelector(
                                            'meta[name="csrf-token"]').getAttribute(
